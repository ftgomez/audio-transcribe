...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Input an mp3 file path and ask questions about its content to ChatGPT'
    )
    parser.add_argument(
        '-path',
        required=True,
    ...
    print('Preprocessing finished. Ask questions about the audio content. Write "exit" to quit.' )
